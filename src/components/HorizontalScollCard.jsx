  ...
  return (
    <div className='container mx-auto px-3 my-10'>
          ...
          <div className='relative'>
                <div ref={contaierRef} className='grid grid-cols-[repeat(auto-fit,200px)] grid-flow-col gap-3 overflow-hidden overflow-x-scroll relative z-10 scroll-smooth transition-all scrolbar-none'>
                    {
                        data.map((data,index)=>{
                        return (
          ...
          <div className='absolute top-0 hidden lg:flex justify-between w-full h-full items-center'>
                    ...
                    <button onClick={handleNext} className='bg-white p-1 text-black rounded-full -ml-2 z-10'>
                        <FaAngleRight/>
                    </button>
                </div>
          </div>
